...
# Generated by configure.sh on __GENERATED_DATE__
...
RUNNER_MEMORY_LIMIT=__RUNNER_MEMORY_LIMIT__

# CPU limit (e.g., 2 for 2 CPUs, 0.5 for half a CPU)
RUNNER_CPU_LIMIT=__RUNNER_CPU_LIMIT__
EOF

# Replace placeholders with actual values
sed -i "s|__GENERATED_DATE__|${GENERATED_DATE}|g" .env.runner
