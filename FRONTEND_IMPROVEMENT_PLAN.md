...
*Based on comprehensive visual analysis of Playwright test screenshots*
...
.hr-percentage { font-size: 2.5rem; font-weight: 600; }
.hr-label { font-size: 1.1rem; font-weight: 500; }
.control-labels { font-size: 0.95rem; font-weight: 500; }
```
...
@media (max-width: 768px) {
  ...
  .hr-tiles { order: 2; grid-template-columns: 1fr 1fr; }
  .google-doc { order: 3; height: 250px; }
}
```
...
<button aria-pressed="false" aria-label="Start Tabata Timer">
```
