        ...
        {hasSpotifyData ? (
          <>
            ...
            <Button
                ...
                sx={{ mt: 2, borderColor: 'grey.600', color: 'grey.300', minWidth: '56px', minHeight: '56px' }}
              >
                Select Playlist
            </Button>
          </>
        ) : (
          <Button onClick={handleBrowseClick} sx={{minWidth: '56px', minHeight: '56px'}}>Select Music</Button>
        )}
      </CardContent>
    </Card>
  )
