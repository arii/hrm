        ...
        <CardContent>
          {spotifyData.trackName && spotifyData.trackName !== 'Awaiting Login...' ? (
            <Box sx={{textAlign: 'center'}}>
              ...
              <Typography>{spotifyData.trackName} - {spotifyData.artist}</Typography>
            </Box>
          ) : (
            <Typography sx={{textAlign: 'center'}}>Login to Spotify on the main dashboard to use this feature.</Typography>
          )}
        </CardContent>
      </Card>
        ...
        <CardContent>
            <Stack spacing={2} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 2 }}>
                ...
                <VolumeControl
                    ...
                    onVolumeChangeCommitted={(newVolume) => sendSpotifyCommand('SET_VOLUME', { volume: newVolume })}
                />
            </Stack>
        </CardContent>
      </Card>
