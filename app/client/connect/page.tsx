...
export default function ConnectPage() {
  ...
  // If persistent session is active (running/paused), we prefer its status over local state
  // to handle page reloads correctly.
  const displayWorkoutControlsStatus =
    persistentStatus === 'finished'
      ? 'idle'
      : persistentStatus !== 'idle'
        ? persistentStatus
        : workoutStatus
  ...
  return (
    <ConnectView
      ...
      caloriesBurned={
        persistentSession ? persistentSession.totalCaloriesBurned : preservedCalories
      }
      userName={userName}
      setUserName={(name) =>
