...
export const generateReleaseNotes = async (
  mergedPrs: ReleaseNotePullRequestSummary[],
  version: string
        ...
        categories: {
          ...
          properties: {
            features: {
              ...
              items: { type: GoogleAI.Type.STRING },
            },
            fixes: {
              type: GoogleAI.Type.ARRAY,
              items: { type: GoogleAI.Type.STRING },
...
export const generateRepoBriefing = async (
  stats: { openIssuesCount: number; openPRsCount: number },
