...
/**
 * Spotify API Service: Handles direct Spotify Web API calls.
 * This module provides a clean interface for Spotify API interactions.
 */
...
/**
 * Generic Spotify API fetch helper
 */
...
export const transferPlayback = (
  ...
  return fetchSpotifyAPI('/me/player', accessToken, 'PUT', {
    device_ids: [deviceId],
    play: true,
  })
}
...
/**
 * Execute player commands (play, pause, next, previous)
 */
