...
const schema = z.object({
  ...
  RATE_LIMIT_SPOTIFY_WINDOW_MINUTES: z.coerce.number().int().positive().default(1),
  RATE_LIMIT_INTERNAL_MAX: z.coerce.number().int().positive().default(100),
  RATE_LIMIT_INTERNAL_WINDOW_MINUTES: z.coerce.number().int().positive().default(1),
  RATE_LIMIT_GENERAL_MAX: z.coerce.number().int().positive().default(200),
  RATE_LIMIT_GENERAL_WINDOW_MINUTES: z.coerce.number().int().positive().default(1),
