...
const envSchema = z
  .object({
    ...
    WS_MAX_CONNECTIONS: z.coerce.number().positive().default(1000),
    SPOTIFY_POLLING_INTERVAL_MS: z.coerce.number().default(5000),
    SPOTIFY_DEVICE_POLLING_INTERVAL_MS: z.coerce.number().default(10000),
    WEBSOCKET_GRACE_PERIOD_MS: z.coerce.number().positive().default(5000),
    WEBSOCKET_WATCHDOG_INTERVAL: z.coerce.number().positive().default(30000),
    BLUETOOTH_MAX_RECONNECTION_ATTEMPTS: z.coerce.number().default(5),
