...
import { HrmDataLogger } from '../services/HrmDataLogger.js'
...
export async function createServices(
  ...
  const hrmDataLogger = new HrmDataLogger()
  ...
  return { tabataService, spotifyService, isSpotifyInitialized, hrmDataLogger }
}
