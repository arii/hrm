...
const handleIncomingMessage = (
  ...
  try {
    ...
    switch (message.type) {
      case 'PING': {
        // This application-level ping is kept for backward compatibility.
        // The new ConnectionMonitor uses the native WebSocket ping/pong.
        // No response is sent here to avoid redundant traffic.
        break
      }
