# Development Notes and Standards
...
- A GitHub Action is triggered by the comment.
- For squash commands, it squashes all commits in the pull request into a single commit.
