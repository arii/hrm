...
While we encourage the use of AI tools to accelerate development, developers are ultimately accountable for the quality, security, and maintainability of the code they submit. All contributions, regardless of origin, must adhere to the project's standards.

### Defining "AI Slop"

"AI Slop" refers to code that is:

- **Ineffective**: It fails to solve the problem correctly or efficiently.
- **Redundant**: It duplicates existing code or functionality.
- **Over-engineered**: It introduces unnecessary complexity, abstractions, or dependencies for a simple problem.
- **Unclear or Obfuscated**: The code is difficult to read, understand, or maintain.
- **Insecure**: It introduces security vulnerabilities.

### Developer Accountability

- **You Own Your Code**: By submitting a pull request, you are certifying that you have reviewed, understood, and tested the code. You are responsible for its quality, even if it was generated by an AI.
- **No "Rubber-Stamping"**: Do not blindly accept AI-generated code. You must be able to explain the logic and justify the design decisions.
- **Refactor and Simplify**: Use AI as a starting point, but always refactor the output to align with project standards, improve readability, and eliminate unnecessary complexity.

### Reviewer Responsibilities

Reviewers are expected to hold AI-assisted code to the same high standards as human-written code.

- **Reject AI Slop**: If a contribution exhibits any of the characteristics of "AI Slop," it should be rejected with clear feedback.
- **Demand Clarity**: If a contributor cannot explain the code they've submitted, the PR should not be approved.
- **Enforce Simplicity**: Challenge over-engineered solutions and demand simplification. The goal is to maintain a clean and sustainable codebase.
