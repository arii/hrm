...
## [0.30.0](https://github.com/arii/hrm/compare/hrm-v0.29.0...hrm-v0.30.0) (2026-03-27)


### Features

* audit vrt tools ([#9592](https://github.com/arii/hrm/issues/9592)) ([f8ec2ee](https://github.com/arii/hrm/commit/f8ec2ee128b808f80cd7ac5ad79196497ece63f7))
...
* **large:** Enable VRT for WorkoutTableHeader and Refactor Workout Table Model ([#8956](https://github.com/arii/hrm/issues/8956)) ([c8e300c](https://github.com/arii/hrm/commit/c8e300c953745e3ff5f605c91504d43d7a85dc4e))
...
* **large:** Refactor Bluetooth HRM reconnection to use linear backoff (ADR-0007) and simplify UI ([#9114](https://github.com/arii/hrm/issues/9114)) ([a219e94](https://github.com/arii/hrm/commit/a219e94ccc75679fc01204c94b8231cee48b2999))
...
* **large:** Unify Persistent Footers for Mobile Optimization ([#9321](https://github.com/arii/hrm/issues/9321)) ([00f714d](https://github.com/arii/hrm/commit/00f714d68316134812b9a6cac3f8b5b9acaa458a))
* **medium:** [BUG] Remove hardcoded Google Doc URLs in DashboardClient ([#9162](https://github.com/arii/hrm/issues/9162)) ([e761ae6](https://github.com/arii/hrm/commit/e761ae6ac544c38c709bd89de121616d97dc0415))
...
* **medium:** Add GitHub Actions variables to control Gemini API usage ([#9408](https://github.com/arii/hrm/issues/9408)) ([8c5bf02](https://github.com/arii/hrm/commit/8c5bf023029cf4a8731bf39800d27d5f3946b8e1))
...
* **medium:** Document and Standardize Next.js Service Singleton Pattern ([#9199](https://github.com/arii/hrm/issues/9199)) ([4045968](https://github.com/arii/hrm/commit/404596829f09159c3623afcbabfe762ce2a010f9))
...
* **medium:** Enhance Bluetooth HRM Connection Resilience and Background Continuity ([#9163](https://github.com/arii/hrm/issues/9163)) ([4a9ca8d](https://github.com/arii/hrm/commit/4a9ca8d5bce4c23934ffeb6a86956f45bb5e6539))
...
* **medium:** Fix knip errors and enable CI check ([#9171](https://github.com/arii/hrm/issues/9171)) ([e2852f8](https://github.com/arii/hrm/commit/e2852f89cb078615158ecd344faaae8224464091))
...
* **medium:** Fix Spotify Volume Control Race Condition and 204 Noise ([#9235](https://github.com/arii/hrm/issues/9235)) ([bf08594](https://github.com/arii/hrm/commit/bf0859475fa4338a814ca02d246b6140d1104c84))
...
* **medium:** Improve Bluetooth Connection Retry & State Management ([#9136](https://github.com/arii/hrm/issues/9136)) ([9904e6a](https://github.com/arii/hrm/commit/9904e6afd4bf7427b2b874047e0da884b0cd10b3))
* **medium:** Improve SignalQualityIndicator responsiveness for BLE failure detection ([#9317](https://github.com/arii/hrm/issues/9317)) ([38c82a6](https://github.com/arii/hrm/commit/38c82a6a263c5f299207f7b8ba4c93da5f15a247))
...
* **medium:** Refactor Bluetooth Connection Retry Logic ([#9134](https://github.com/arii/hrm/issues/9134)) ([82d2dec](https://github.com/arii/hrm/commit/82d2dec3418cefe49913c9beccc0e46c28e62a5d))
* **medium:** Refactor ConnectView user profile state management ([#9130](https://github.com/arii/hrm/issues/9130)) ([2610e51](https://github.com/arii/hrm/commit/2610e51ada1d45884caed329f72409d51f20f1ff))
* **medium:** Refactor ErrorFallback VRT to trigger error client-side ([#9159](https://github.com/arii/hrm/issues/9159)) ([faf4228](https://github.com/arii/hrm/commit/faf422808d124976be011a293f9db94039216ece))
...
* **medium:** Remove redundant clear icons in Spotify search inputs ([#9453](https://github.com/arii/hrm/issues/9453)) ([c594559](https://github.com/arii/hrm/commit/c594559467053b50b69a11f30ec73e273bf0e3bd))
...
* **medium:** Standardize Spotify track playback command dispatch ([#9546](https://github.com/arii/hrm/issues/9546)) ([094fc9c](https://github.com/arii/hrm/commit/094fc9c93905b019235f26d4095bf06549dd6dec))
* **small:** Add data-testid to SpotifyDeviceSelector ([#9548](https://github.com/arii/hrm/issues/9548)) ([ce3fec4](https://github.com/arii/hrm/commit/ce3fec412cf40232a74548454590d047cae54699))
...
* **small:** Enhance Spotify Volume Slider UX: Length, Touch Target, and Layout ([#9316](https://github.com/arii/hrm/issues/9316)) ([c690ada](https://github.com/arii/hrm/commit/c690ada00b9d340637db989d898dea4a95271709))
...
* **small:** Extract ResetSection component from ConnectView.tsx ([#8955](https://github.com/arii/hrm/issues/8955)) ([2e7236e](https://github.com/arii/hrm/commit/2e7236e1ef0bc908f0bef9923e799cc960316bfe))
...
* **small:** Fix Native Table configuration and API routing ([#9137](https://github.com/arii/hrm/issues/9137)) ([5c6ac4a](https://github.com/arii/hrm/commit/5c6ac4a8ec9178af08f5c15b583e7e453c1111a1))
...
* **small:** Refactor: Harden Spotify Service Initialization and Error Handling ([#9132](https://github.com/arii/hrm/issues/9132)) ([7d6e56c](https://github.com/arii/hrm/commit/7d6e56c90fa31cd6cf6da7237953aff46be0f9ea))
...
* **ci:** resolve BASE_SHA/HEAD_SHA crash on issue_comment triggers ([#9489](https://github.com/arii/hrm/issues/9489)) ([10f99d8](https://github.com/arii/hrm/commit/10f99d87f25b07f7c5e73ff150985465e925a789))
...
* **spotify:** Volume control failures on /client/control - duplicate player and snap-back ([#9282](https://github.com/arii/hrm/issues/9282)) ([55f65cc](https://github.com/arii/hrm/commit/55f65cc5b03564b72ee999342299b27c0bfd897e))
...
* **bluetooth:** Implement proactive signal quality degradation ([#3724](https://github.com/arii/hrm/issues/3724)) ([fcc853f](https://github.com/arii/hrm/commit/fcc853f4f39eb7bc7e726332f39a7206ec27b126))
...
* **small:** Fix: Update DashboardSectionLoadingSkeleton props to string ([#3909](https://github.com/arii/hrm/issues/3909)) ([b80e4ef](https://github.com/arii/hrm/commit/b80e4ef117d9a195b05a40e7acbb841f31e0934d))
...
* **small:** Restore Spotify Scope Persistence ([#3714](https://github.com/arii/hrm/issues/3714)) ([22d7389](https://github.com/arii/hrm/commit/22d7389f89d8b82028d6135db1a01c97556a0f2e))
...
* **workouts:** Enhance Type Safety for workoutStatus ([#3716](https://github.com/arii/hrm/issues/3716)) ([bc94cc1](https://github.com/arii/hrm/commit/bc94cc1181e2cc831cc6a3a9cd35b9110b5f03c4))
...
* **medium:** feat: Implement Bluetooth Signal Quality Indicator ([#3314](https://github.com/arii/hrm/issues/3314)) ([ecf0d39](https://github.com/arii/hrm/commit/ecf0d39e2c0e9e5616bc66db06f73bb1c8ab79f8))
...
* **medium:** Improve Mobile UI for /client/control ([#3325](https://github.com/arii/hrm/issues/3325)) ([199d412](https://github.com/arii/hrm/commit/199d412abc69378dc9dff9a71fb0879e76383df3))
* **small:** Fix Spotify Volume Slider Reverting Behavior ([#3317](https://github.com/arii/hrm/issues/3317)) ([bbd3826](https://github.com/arii/hrm/commit/bbd38261daa2a721e1f5e0002af743e5aef62e17))
