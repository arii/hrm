...
<<<<<<< HEAD
import { ClientCommandMessage, SpotifyData, SpotifyCommandMessage } from '@/types/websocket'
=======
...
const SpotifyDisplay = ({ spotifyData, connectionStatus, sendData }: SpotifyDisplayProps) => {
