...
const MockWebSocketProvider = ({ children, value }: any) => (
...
export const Loading: Story = {
    decorators: [
        (Story) => (
            <MockWebSocketProvider value={{ ...defaultContext, connectionStatus: 'Connecting...' }}>
                <Story />
    ...
    decorators: [
        (Story) => (
            <MockWebSocketProvider value={{
                ...defaultContext,
                hrmData: [
                    { clientId: '1', name: 'User A', value: 40, maxHr: 190 },
                ],
                activeAlerts: [
