...
describe('Calorie Estimation', () => {
  const testCases: Array<[string, CalorieEstimationParams, number]> = [
    ['realistic data', { heartRate: 150, age: 30, weightKg: 70 }, 14.22],
    ['very low heart rate', { heartRate: 29, age: 30, weightKg: 70 }, 0],
    ['heart rate at boundary', { heartRate: 30, age: 30, weightKg: 70 }, 0],
    ['older, lighter person', { heartRate: 140, age: 65, weightKg: 55 }, 13.68],
    [
    ...
    ['low but valid values', { heartRate: 90, age: 40, weightKg: 60 }, 5.18],
  ]
