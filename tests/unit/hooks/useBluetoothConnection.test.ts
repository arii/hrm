...
describe('useBluetoothConnection', () => {
  ...
  it('should request a device and connect to it', async () => {
    ...
    const { result } = renderHook(() => useBluetoothConnection({ serviceUuids: ['s1'], onConnect }));
  ...
  it('should auto-connect to a saved device', async () => {
    ...
    const { result } = renderHook(() => useBluetoothConnection({ serviceUuids: ['s1'] }));
  ...
  it('should handle manual disconnection', async () => {
    ...
    const { result } = renderHook(() => useBluetoothConnection({ serviceUuids: ['s1'], onDisconnect }));
