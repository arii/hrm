...
describe('getHrZoneProps', () => {
  ...
  const testCases = [
    ...
    { zone: HrZoneName.WarmUp, hr: 100, expectedColor: theme.palette.getContrastText(HR_ZONE_UI_PROPS_MAP[HrZoneName.WarmUp].bgColor) },
    { zone: HrZoneName.FatBurn, hr: 130, expectedColor: '#FFFFFF' },
    { zone: HrZoneName.Cardio, hr: 150, expectedColor: '#FFFFFF' },
    { zone: HrZoneName.Peak, hr: 170, expectedColor: theme.palette.getContrastText(HR_ZONE_UI_PROPS_MAP[HrZoneName.Peak].bgColor) },
    { zone: HrZoneName.Max, hr: 190, expectedColor: theme.palette.getContrastText(HR_ZONE_UI_PROPS_MAP[HrZoneName.Max].bgColor) },
  ];
