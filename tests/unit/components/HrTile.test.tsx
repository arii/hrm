...
describe('HrTile', () => {
  it('renders the correct background and text color for the Peak zone', () => {
    ...
    expect(card).toHaveStyle(`color: ${theme.palette.getContrastText(ZONE_COLORS.red)}`)
  })
  ...
  it('renders the correct background and text color for the Cardio zone', () => {
    ...
    expect(card).toHaveStyle(`color: ${theme.palette.getContrastText(ZONE_COLORS.yellow)}`)
  })
  ...
  it('renders the correct background and text color for the Fat Burn zone', () => {
    ...
    expect(card).toHaveStyle(`color: ${theme.palette.getContrastText(ZONE_COLORS.green)}`)
  })
  ...
  it('renders the correct background and text color for the Warm-up zone', () => {
    ...
    expect(card).toHaveStyle(`color: ${theme.palette.getContrastText(ZONE_COLORS.blue)}`)
  })
  ...
  it('renders the correct background and text color for the low-intensity zone', () => {
    ...
    expect(card).toHaveStyle(`color: ${theme.palette.getContrastText(ZONE_COLORS.grey)}`)
  })
})
