...
describe('HrTile', () => {
  ...
  it('renders the correct background and text color for the Anaerobic (Peak) zone', () => {
    // 92% -> Zone 5
  ...
  it('renders the correct background and text color for the Threshold (Cardio) zone', () => {
    // 85% -> Zone 4
  ...
  it('renders the correct background and text color for the Aerobic (Fat Burn) zone', () => {
    // 75% -> Zone 3
  ...
  it('renders the correct background and text color for the Easy (Warm-up) zone', () => {
    // 65% -> Zone 2
  ...
  it('renders the correct background and text color for the Warm Up (Recovery) zone', () => {
    // 55% -> Zone 1
  ...
  it('updates aria-label to include zone information', () => {
    ...
    expect(card).toHaveAttribute(
      'aria-label',
      `Heart rate monitor for Test: 150 beats per minute, 80% of maximum, ZONE 4: ${HR_ZONE_CONFIG.ZONE_4.label}`
    )
  })
})
