...
// in the CI environment (Issue #TBD). The mock injection and window patching logic
// is correct, but the runner crashes with "Log file not found" when this specific
// test context is active.
// TODO: Re-enable once CI infrastructure is upgraded or debugged.
