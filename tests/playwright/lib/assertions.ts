 ...
 * @param options - Optional configuration overrides
 */
async function assertElementSnapshot(
  locator: Locator,
  snapshotName: string,
  options: {
    mask?: Locator[]
 ...
 */
async function assertTimerState(
  page: Page,
 ...
 * @param options - Optional configuration
 */
async function assertWebSocketConnected(
  page: Page,
  options: { timeout?: number } = {}
): Promise<void> {
 ...
 * @param options - Optional configuration
 */
async function assertHrDataVisible(
  page: Page,
  userName: string,
  options: { timeout?: number } = {}
): Promise<void> {
 ...
 * @param options - Optional configuration
 */
async function assertButtonState(
  page: Page,
  buttonName: string,
