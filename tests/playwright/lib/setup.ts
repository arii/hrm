 ...
 */
async function setupVisualRegressionTest(pages: {
  dashboardPage: Page
  controlPage: Page
  mockPage: Page
  connectPage: Page
 ...
 */
async function setupMinimalVisualRegressionTest(
  page: Page,
  path: string = ''
): Promise<void> {
 ...
 */
async function setupComprehensiveTest(options: {
  page: Page
  context: BrowserContext
}): Promise<void> {
 ...
 * @param options - Configuration options
 */
async function setupCoreTest(options: { page: Page }): Promise<void> {
  const { page } = options
 ...
 * @param controlPage - The control panel Page object
 */
async function startTimer(controlPage: Page): Promise<void> {
 ...
 * @param options - Configuration options
 */
async function setupMockHrStreaming(
  mockPage: Page,
 ...
 * @param mockPage - The mock client Page object
 */
async function startMockHrStreaming(mockPage: Page): Promise<void> {
 ...
 */
async function prepareForVisualRegression(
  ...pages: Page[]
): Promise<void> {
