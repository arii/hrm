...
export async function takeScreenshot(
  ...
  const variableTextMask = page.locator('.variable-text-container')
  const existingMasks = Array.isArray(screenshotOptions.mask)
  ...
  const finalOptions = {
    ...
    ...SCREENSHOT_OPTIONS,
    ...screenshotOptions,
    mask: [...existingMasks, variableTextMask],
  }
