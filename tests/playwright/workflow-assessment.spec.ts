...
test.describe('HRM Workflow Assessment', () => {
  ...
  test('Complete Workout Session - Tabata with HR Monitoring', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('workflow-complete-session.png', { fullPage: true })
  })
  ...
  test('Multi-Device Coordination Simulation', async ({ page, context }) => {
    ...
    await mockPage.waitForSelector('text=/HRM Mock Streamer/', { timeout: 5000 })
    ...
    await expect(controlPage).toHaveScreenshot('multi-device-control.png', { fullPage: true })
    await expect(dashboardPage).toHaveScreenshot('multi-device-dashboard.png', { fullPage: true })
    await expect(mockPage).toHaveScreenshot('multi-device-hr-monitor.png', { fullPage: true })
  ...
  test('Error Recovery and Edge Cases', async ({ page }) => {
    ...
    await page.waitForTimeout(2000)
    await expect(page).toHaveScreenshot('error-offline-state.png', { fullPage: true })
    
    // Restore connection
    await page.context().setOffline(false)
    await page.waitForTimeout(2000)
    await expect(page).toHaveScreenshot('error-reconnected-state.png', { fullPage: true })
    ...
    await page.waitForTimeout(500)
    await expect(page).toHaveScreenshot('error-invalid-timer-config.png', { fullPage: true })
    ...
    await page.click('text=Stopwatch')
    await page.waitForTimeout(500)
    await expect(page).toHaveScreenshot('error-rapid-mode-switching.png', { fullPage: true })
  })
  ...
  test('Performance Under Load Simulation', async ({ page }) => {
    ...
    await page.waitForSelector('text=/WORK:|Timer/', { timeout: 5000 })
    await page.waitForTimeout(2000)
    await expect(page).toHaveScreenshot('performance-high-frequency-updates.png', { fullPage: true })
    ...
    await page.waitForTimeout(3000)
    await expect(page).toHaveScreenshot('performance-timer-under-load.png', { fullPage: true })
  ...
  test('Accessibility and Keyboard Navigation', async ({ page }) => {
    ...
    await page.keyboard.press('Tab')
    await page.waitForTimeout(200)
    await expect(page).toHaveScreenshot('accessibility-keyboard-focus.png', { fullPage: true })
    
    // Test keyboard shortcuts
    await page.keyboard.press('Space') // Should activate focused element
    await page.waitForTimeout(500)
    await expect(page).toHaveScreenshot('accessibility-keyboard-activation.png', { fullPage: true })
    ...
    await page.waitForTimeout(1000)
    await expect(page).toHaveScreenshot('accessibility-high-contrast.png', { fullPage: true })
  })
  ...
  test('Data Persistence and State Recovery', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('persistence-timer-state.png', { fullPage: true })
    ...
    await expect(page).toHaveScreenshot('persistence-hr-connection.png', { fullPage: true })
