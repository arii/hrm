...
test.describe('Tabata Timer', () => {
  test('should transition through PREPARE, WORK, and REST states', async ({ page, context }) => {
    ...
    await expect(page.locator('[data-testid="timer-display-container"]')).toHaveAttribute('data-timer-phase', 'PREPARE');
    ...
    await expect(page.locator('[data-testid="timer-display-container"]')).toHaveAttribute('data-timer-phase', 'WORK');
    ...
    await expect(page.locator('[data-testid="timer-display-container"]')).toHaveAttribute('data-timer-phase', 'REST');
