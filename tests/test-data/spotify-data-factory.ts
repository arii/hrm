  ...
  const defaultTrack: Track = {
    album: {
      ...
      images: [
        ...
        { url: 'https://i.scdn.co/image/ab67616d00001e02e787cffec20aa2a396a61647', height: 300, width: 300 },
        { url: 'https://i.scdn.co/image/ab67616d00004851e787cffec20aa2a396a61647', height: 64, width: 64 },
      ],
      name: 'Lover',
    ...
    name: 'Cruel Summer',
    popularity: 90,
    preview_url: 'https://p.scdn.co/mp3-preview/e4a8b1b3b1e3b1e3b1e3b1e3b1e3b1e3b1e3b1e3',
    track_number: 2,
    type: 'track',
 ...
 */
export const createSpotifyPlaylist = (overrides: Partial<Playlist> = {}): Playlist => {
  const defaultPlaylist: Playlist = {
    ...
    images: [{ url: 'https://i.scdn.co/image/ab67706f00000002aa9072b22f3aa2d86c75de81', height: 640, width: 640 }],
      ...
      items: [
        {
          ...
          added_by: { id: 'spotify', type: 'user', uri: 'spotify:user:spotify' },
          is_local: false,
