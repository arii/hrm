...
/**
 * @deprecated HrmData is deprecated in favor of HrmStaticMetadata (for static data) and HrmMetric (for real-time data).
 */
 ...
 * This is sent once upon connection. Static data is now hydrated via SSR.
 */
 ...
 */
export type StateSnapshot = Omit<InitialStateSnapshotPayload, 'hrmMetrics'>
